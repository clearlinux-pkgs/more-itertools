...
%prep
%setup -q -n more-itertools-8.8.0
cd %{_builddir}/more-itertools-8.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621606862
...
cp %{_builddir}/more-itertools-8.8.0/LICENSE %{buildroot}/usr/share/package-licenses/more-itertools/0d43a836dac65c0ea426ad49c881a1086600bf85
cp %{_builddir}/more-itertools-8.8.0/docs/license.rst %{buildroot}/usr/share/package-licenses/more-itertools/ff8a160b2ccafe5031612c084dfcd3cc95950414
