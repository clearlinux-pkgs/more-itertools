...
Source0  : https://files.pythonhosted.org/packages/d6/03/37d7c431c4c1c17507fb7b89240ddb7be70f2027277960d525f1679363c1/more-itertools-8.5.0.tar.gz
...
%prep
%setup -q -n more-itertools-8.5.0
cd %{_builddir}/more-itertools-8.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598896546
...
cp %{_builddir}/more-itertools-8.5.0/LICENSE %{buildroot}/usr/share/package-licenses/more-itertools/0d43a836dac65c0ea426ad49c881a1086600bf85
cp %{_builddir}/more-itertools-8.5.0/docs/license.rst %{buildroot}/usr/share/package-licenses/more-itertools/ff8a160b2ccafe5031612c084dfcd3cc95950414
