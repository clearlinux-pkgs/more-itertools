...
Source0  : https://files.pythonhosted.org/packages/df/8c/c278395367a46c00d28036143fdc6583db8f98622b83875403f16473509b/more-itertools-8.1.0.tar.gz
...
%prep
%setup -q -n more-itertools-8.1.0
cd %{_builddir}/more-itertools-8.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578940650
...
cp %{_builddir}/more-itertools-8.1.0/LICENSE %{buildroot}/usr/share/package-licenses/more-itertools/0d43a836dac65c0ea426ad49c881a1086600bf85
cp %{_builddir}/more-itertools-8.1.0/docs/license.rst %{buildroot}/usr/share/package-licenses/more-itertools/ff8a160b2ccafe5031612c084dfcd3cc95950414
