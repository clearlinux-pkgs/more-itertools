...
Source0  : https://files.pythonhosted.org/packages/16/e8/b371710ad458e56b6c74b82352fdf1625e75c03511c66a75314f1084f057/more-itertools-8.3.0.tar.gz
...
%prep
%setup -q -n more-itertools-8.3.0
cd %{_builddir}/more-itertools-8.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589855890
...
cp %{_builddir}/more-itertools-8.3.0/LICENSE %{buildroot}/usr/share/package-licenses/more-itertools/0d43a836dac65c0ea426ad49c881a1086600bf85
cp %{_builddir}/more-itertools-8.3.0/docs/license.rst %{buildroot}/usr/share/package-licenses/more-itertools/ff8a160b2ccafe5031612c084dfcd3cc95950414
