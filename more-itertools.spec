...
Source0  : https://files.pythonhosted.org/packages/67/4a/16cb3acf64709eb0164e49ba463a42dc45366995848c4f0cf770f57b8120/more-itertools-8.4.0.tar.gz
...
%prep
%setup -q -n more-itertools-8.4.0
cd %{_builddir}/more-itertools-8.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592409555
...
cp %{_builddir}/more-itertools-8.4.0/LICENSE %{buildroot}/usr/share/package-licenses/more-itertools/0d43a836dac65c0ea426ad49c881a1086600bf85
cp %{_builddir}/more-itertools-8.4.0/docs/license.rst %{buildroot}/usr/share/package-licenses/more-itertools/ff8a160b2ccafe5031612c084dfcd3cc95950414
