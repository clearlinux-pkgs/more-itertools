...
Source0  : https://files.pythonhosted.org/packages/fd/2d/90ea8e03076d46166b14c24c87b07ef8cf3d4e0df9a59aefbbd4db3bef7b/more-itertools-8.7.0.tar.gz
...
%prep
%setup -q -n more-itertools-8.7.0
cd %{_builddir}/more-itertools-8.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612800955
...
cp %{_builddir}/more-itertools-8.7.0/LICENSE %{buildroot}/usr/share/package-licenses/more-itertools/0d43a836dac65c0ea426ad49c881a1086600bf85
cp %{_builddir}/more-itertools-8.7.0/docs/license.rst %{buildroot}/usr/share/package-licenses/more-itertools/ff8a160b2ccafe5031612c084dfcd3cc95950414
