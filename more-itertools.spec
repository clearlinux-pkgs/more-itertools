...
Source0  : https://files.pythonhosted.org/packages/8a/f7/93cf3c81629c95f6f40e509f7cd63985a6ddd829181a66c1c8ef101e55f2/more-itertools-8.10.0.tar.gz
...
%prep
%setup -q -n more-itertools-8.10.0
cd %{_builddir}/more-itertools-8.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631892158
...
cp %{_builddir}/more-itertools-8.10.0/LICENSE %{buildroot}/usr/share/package-licenses/more-itertools/0d43a836dac65c0ea426ad49c881a1086600bf85
cp %{_builddir}/more-itertools-8.10.0/docs/license.rst %{buildroot}/usr/share/package-licenses/more-itertools/ff8a160b2ccafe5031612c084dfcd3cc95950414
