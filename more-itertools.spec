...
Source0  : https://files.pythonhosted.org/packages/5a/e7/b7883994ae36a5167214ea573b10dce626c65d9eeea1fa1e853b8e5a3b73/more-itertools-8.0.0.tar.gz
...
%prep
%setup -q -n more-itertools-8.0.0
cd %{_builddir}/more-itertools-8.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575279934
...
cp %{_builddir}/more-itertools-8.0.0/LICENSE %{buildroot}/usr/share/package-licenses/more-itertools/0d43a836dac65c0ea426ad49c881a1086600bf85
cp %{_builddir}/more-itertools-8.0.0/docs/license.rst %{buildroot}/usr/share/package-licenses/more-itertools/ff8a160b2ccafe5031612c084dfcd3cc95950414
