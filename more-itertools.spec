...
Source0  : https://files.pythonhosted.org/packages/14/77/a496c86b4bf9328269b65dc4d97f127cc78af59539a13b49631b36896234/more-itertools-8.11.0.tar.gz
...
%prep
%setup -q -n more-itertools-8.11.0
cd %{_builddir}/more-itertools-8.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636506828
...
cp %{_builddir}/more-itertools-8.11.0/LICENSE %{buildroot}/usr/share/package-licenses/more-itertools/0d43a836dac65c0ea426ad49c881a1086600bf85
cp %{_builddir}/more-itertools-8.11.0/docs/license.rst %{buildroot}/usr/share/package-licenses/more-itertools/ff8a160b2ccafe5031612c084dfcd3cc95950414
